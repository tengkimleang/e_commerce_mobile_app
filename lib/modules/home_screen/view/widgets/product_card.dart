...
class ProductCard extends StatelessWidget {
  ...
  static const double _detailsMinHeight = 88;
  static const double _detailsWithCountryMinHeight = 108;
  static const double _maxImageHeightFactor = 0.68;
        ...
        return GestureDetector(
          ...
          child: Container(
            ...
            child: Column(
              ...
              children: [
                SizedBox(
                  key: const ValueKey('product-card-image-frame'),
                  height: imageHeight,
                      ...
                      Positioned(
                        ...
                        child: BlocBuilder<FavoriteBloc, FavoriteState>(
                          builder: (context, favoriteState) {
                            final isFavorite = favoriteState.contains(
                              product.id,
                            );
                            return GestureDetector(
                              onTap: () {
  ...
  double _imageHeightFor(BoxConstraints constraints) {
    final width = constraints.maxWidth;
    final preferredHeight = width.isFinite ? width / _imageAspectRatio : 150.0;
    if (!constraints.maxHeight.isFinite) return preferredHeight;

    final detailsHeight = countryLabel == null
        ? _detailsMinHeight
        : _detailsWithCountryMinHeight;
    final maxByRemainingHeight = constraints.maxHeight - detailsHeight;
    final maxByCardRatio = constraints.maxHeight * _maxImageHeightFactor;
    final maxHeight = maxByRemainingHeight < maxByCardRatio
        ? maxByRemainingHeight
        : maxByCardRatio;

    if (maxHeight <= 0) return preferredHeight;
    return preferredHeight < maxHeight ? preferredHeight : maxHeight;
  }
}
