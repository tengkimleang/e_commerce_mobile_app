...
import 'package:e_commerce_mobile_app/modules/home/chipmong_supermarket/view/price_checking_view.dart';
          ...
          child: Column(
            children: [
                ...
                child: SingleChildScrollView(
                  child: Column(
                    ...
                    children: [
                      ...
                      const Text('Customer Name', style: TextStyle(fontSize: 14)),
                      const SizedBox(height: 8),
                      _buildField(initial: ''),
                      ...
                      GestureDetector(
                        onTap: () async {
                          final result = await Navigator.of(context).push<Map<String, String>>(MaterialPageRoute(builder: (_) => const PriceCheckingView()));
                          if (result != null) {
                            setState(() {
                              // avoid duplicates by id
                              if (!_selected.any((e) => e['id'] == result['id'])) _selected.add(result);
                            });
                          }
                        },
                        child: Container(
                            ...
                            children: const [
                              Expanded(
                                child: Padding(
                                  ...
                                  child: Text('Search product', style: TextStyle(color: Colors.grey)),
                                ),
                              ),
              ...
              Container(
                ...
                height: 64,
                decoration: const BoxDecoration(color: Color(0xFFEC407A), borderRadius: BorderRadius.only(topLeft: Radius.circular(8), topRight: Radius.circular(8))),
                child: TextButton(
      ...
      child: Row(
        children: [
          Container(
            ...
            child: Image.network(p['image'] ?? '', fit: BoxFit.cover, errorBuilder: (_, __, ___) => const Icon(Icons.image)),
          ),
          const SizedBox(width: 12),
          Expanded(child: Text(p['title'] ?? '', style: const TextStyle(fontSize: 14))),
          IconButton(
            onPressed: () {
