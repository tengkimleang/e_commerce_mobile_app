...
class _SupermarketMainViewState extends State<SupermarketMainView> {
    ...
    return List<Widget>.generate(10, (index) {
      return Padding(
        ...
        child: ProductCarouselSection(
          ...
          height: index == 0 || index == 2 || index == 4 || index == 6 || index == 8 ? 160 : 180,
          onViewAllTap: () {},
          onCategoryTap: () {},
          onFavoriteTap: (_) {},
  ...
  Widget _buildCustomProductCard({required ProductModel product, required int rowIndex}) {
   switch(rowIndex){
    case 0:
    return _getMilkProducts().where((p) => p.id == product.id).map((p) => ProductCard(product: p)).first;
    case 1:
    return _getOrangeProducts().where((p) => p.id == product.id).map((p) => ProductCard(product: p)).first;
    case 2:
    return _getBakeryProducts().where((p) => p.id == product.id).map((p) => ProductCard(product: p)).first;
    case 3:
    return _getSnackProducts().where((p) => p.id == product.id).map((p) => ProductCard(product: p)).first;
    case 4:
    return _getSoftDrinkProducts().where((p) => p.id == product.id).map((p) => ProductCard(product: p)).first;
    case 5:
    return _getNoodleProducts().where((p) => p.id == product.id).map((p) => ProductCard(product: p)).first;
    case 6:
    return _getFrozenProducts().where((p) => p.id == product.id).map((p) => ProductCard(product: p)).first;
    case 7:
    return _getHouseholdProducts().where((p) => p.id == product.id).map((p) => ProductCard(product: p)).first;
    case 8:
    return _getPersonalCareProducts().where((p) => p.id == product.id).map((p) => ProductCard(product: p)).first;
    case 9:
    return _getBabyProducts().where((p) => p.id == product.id).map((p) => ProductCard(product: p)).first;
    default:
...
List<ProductModel> _getBakeryProducts() {
    return [
      ProductModel(
        ...
        name: 'Baguette Bread',
        price: 1.50,
        imageUrl: 'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSaKirtgDcOcqy_UrduOm6SZ5QT3RNt9z8DNQ&s',
        isFavorite: false,
      ),
      ProductModel(
        id: '10',
        ...
        price: 2.25,
        imageUrl: 'https://theculinarycollectiveatl.com/wp-content/uploads/2024/03/2148516578.webp',
        isFavorite: false,
      ),
      ProductModel(
        id: '11',
        ...
        price: 1.75,
        imageUrl: 'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcS1pAgeowdlTw4VQZOR7TF9Vw9Rn1lZNiKU-Q&s',
        isFavorite: false,
      ),
      ProductModel(
        id: '12',
        name: 'Cinnamon Roll',
        price: 2.00,
        imageUrl: 'https://dev.bakerpedia.com/wp-content/uploads/2020/06/Pastry_baking-processes-e1593464950587.jpg',
        isFavorite: false,
      ),
    ];
  }
  ...
  List<ProductModel> _getSnackProducts() {
    return [
      ProductModel(
        ...
        name: 'Potato Chips',
        price: 1.99,
        imageUrl: 'https://images-na.ssl-images-amazon.com/images/I/517Pa8vUG0L.jpg',
        isFavorite: false,
      ),
      ProductModel(
        id: '14',
        name: 'Chocolate Bar',
        price: 0.99,
        imageUrl: 'https://frontierbiscuit.com/cdn/shop/products/Potato_chips.webp?v=1692429566',
        isFavorite: false,
      ),
      ProductModel(
        id: '15',
        name: 'Mixed Nuts',
        price: 3.50,
        imageUrl: 'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSOJA-6dmtS-xNlx1kUX25V48MTz9QAc3I_qA&s',
        isFavorite: false,
      ),
      ProductModel(
        id: '16',
        name: 'Granola Bar',
        price: 1.25,
        imageUrl: 'https://caribshopper.com/cdn/shop/products/sunshine-snacks-potato-chips-6-or-12-pack-caribshopper-940101_1080x.jpg?v=1663023573',
        isFavorite: false,
      ),
    ];
  }
  List<ProductModel> _getSoftDrinkProducts() {
    return [
      ProductModel(
        ...
        name: 'Cola Soda',
        price: 1.50,
        imageUrl: 'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcR3-gxDPR43rg5voQTtrQ5mBCOMLhWQUpHINg&s',
        isFavorite: false,
      ),
      ProductModel(
        id: '18',
        ...
        price: 1.25,
        imageUrl: 'https://at.coca-colahellenic.com/en/our-24-7-portfolio/sparkling/_jcr_content/root/sectionteaser_image/container/teaser.coreimg.jpeg/1651242522120/brands.jpeg',
        isFavorite: false,
      ),
      ProductModel(
        id: '19',
        name: 'Orange Soda',
        price: 1.30,
        imageUrl: 'https://i5.walmartimages.com/seo/Sunkist-Orange-Soda-Pop-2-L-Bottle_3002740e-3996-4c0f-84eb-eceb88ea2ead.504b27cdf06e785897b7ef739ccf9b25.jpeg',
        isFavorite: false,
      ),
      ProductModel(
        id: '20',
        name: 'Ginger Ale',
        price: 1.75,
        imageUrl: 'https://media.makrocambodiaclick.com/PRODUCT_1630310862860.jpeg',
        isFavorite: false,
      ),
    ];
  }
  ...
  List<ProductModel> _getNoodleProducts() {
    return [
      ProductModel(
        ...
        name: 'Instant Ramen',
        price: 0.75,
        imageUrl: 'https://m.media-amazon.com/images/I/710yLnSkQgL._SL1200_.jpg',
        isFavorite: false,
      ),
      ProductModel(
        id: '22',
        name: 'Rice Noodles',
        price: 1.50,
        imageUrl: 'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQ742i14MS2X5sGAWjpgiDFj3GmWfPmuQ1Wbg&s',
        isFavorite: false,
      ),
      ProductModel(
        id: '23',
        name: 'Egg Noodles',
        price: 1.25,
        imageUrl: 'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQb-WQMWCruEHVvvOPT-w6CIgsKkU5-k4wRKA&s',
        isFavorite: false,
      ),
      ProductModel(
        id: '24',
        name: 'Soba Noodles',
        price: 2.00,
        imageUrl: 'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTa6B-JmTnu6MAnnUuh-PVdraga0Mt7zFZ9zw&s',
        isFavorite: false,
      ),
    ];
  }
  ...
  List<ProductModel> _getFrozenProducts() {
    return [
      ProductModel(
        ...
        name: 'Frozen Pizza',
        price: 4.99,
        imageUrl: 'https://grillonadime.com/wp-content/uploads/2024/06/Frozen-Pizza-on-Blackstone-low-res-13-1.jpg',
        isFavorite: false,
      ),
      ProductModel(
        id: '26',
        name: 'Ice Cream Tub',
        price: 3.50,
        imageUrl: 'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQl-bR-NeaPgq1GrUR1P5IEiO3JyoUwVkao6w&s',
        isFavorite: false,
      ),
      ProductModel(
        id: '27',
        ...
        price: 2.25,
        imageUrl: 'https://i5.walmartimages.com/seo/Great-Value-Frozen-Peas-Carrots-Gluten-Free-12-oz-Steamable-Bag_4965b44b-d7c1-4714-96aa-5bab328cf176.f446c946f8892a1799264540713146d5.jpeg',
        isFavorite: false,
      ),
      ProductModel(
        id: '28',
        name: 'Frozen Berries',
        price: 3.00,
        imageUrl: 'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTU_bGfm9veREzjRbSr0A2nY8s4I4UyyKKYHA&s',
        isFavorite: false,
      ),
    ];
  }
  ...
  List<ProductModel> _getHouseholdProducts() {
    return [
      ProductModel(
        ...
        price: 5.99,
        imageUrl: 'https://cdn.thewirecutter.com/wp-content/media/2025/12/BEST-LAUNDRY-DETERGENTS-2048px-0210-2x1-1.jpg?width=2048&quality=75&crop=2:1&auto=webp',
        isFavorite: false,
      ),
      ProductModel(
        id: '30',
        name: '`Dish Soap`',
        price: 2.50,
        imageUrl: 'https://images.thdstatic.com/productImages/d9bd2952-5230-45db-81e7-8f7e99f18794/svn/dawn-dish-soap-003077209403-64_1000.jpg',
        isFavorite: false,
      ),
      ProductModel(
        id: '31',
        ...
        price: 3.75,
        imageUrl: 'https://hips.hearstapps.com/hmg-prod/images/gh-062222-best-all-purpose-cleaners-1655921002.png?crop=0.6666666666666666xw:1xh;center,top&resize=1200:*',
        isFavorite: false,
      ),
      ProductModel(
        id: '32',
        name: 'Paper Towels',
        price: 4.00,
        imageUrl: 'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRGbJ53pxoCBjgdiY1a_8YpG6wqi_C8eh50iw&s',
        isFavorite: false,
      ),
    ];
  }
  ...
  List<ProductModel> _getPersonalCareProducts() {
    return [
      ProductModel(
        ...
        name: 'Shampoo Bottle',
        price: 6.99,
        imageUrl: 'https://t4.ftcdn.net/jpg/00/47/30/15/360_F_47301594_mLvjoHeB4UvNvZ0zOotvrhPfqLQlIDRv.jpg',
        isFavorite: false,
      ),
      ProductModel(
        id: '34',
        name: 'Body Wash',
        price: 5.50,
        imageUrl: 'https://acmarca.com/en/wp-content/uploads/sites/2/2025/02/areas_personal_care_higiene_bdg_internacional_03.png',
        isFavorite: false,
      ),
      ProductModel(
        id: '36',
        ...
        price: 3.25,
        imageUrl: 'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSPnlafGFZRIvGcqzU4hbYNl87wM4cKpBZjxQ&s',
        isFavorite: false,
      ),
      ProductModel(
        id: '37',
        ...
        price: 4.00,
        imageUrl: 'https://i5.walmartimages.com/seo/Dove-Men-Care-Extra-Fresh-72H-Men-s-Antiperspirant-Deodorant-Stick-2-7-oz_d855a43f-f964-49f0-bff4-851f3b0ebe72.ac132ca29b5044d8184e96410526bbdd.jpeg',
        isFavorite: false,
      ),
    ];
  }
