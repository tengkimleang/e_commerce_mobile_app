...
class AppLocalizationsKm extends AppLocalizations {
  ...
  @override
  String get privacyPolicyTitle => 'គោលការណ៍ភាពឯកជន';

  @override
  String get termsOfConditionsTitle => 'លក្ខខណ្ឌនៃកិច្ចព្រមព្រៀង';

  @override
  String get privacyPolicyIntro =>
      'នៅឯកម្មវិធី CHIP MONG RETAIL APP យើងប្តេជ្ញាការពារភាពឯកជនរបស់អតិថិជន និងធានាថាព័ត៌មានផ្ទាល់ខ្លួនរបស់អតិថិជនត្រូវបានគ្រប់គ្រងក្នុងលក្ខណៈសុវត្ថិភាព និងមានទំនួលខុសត្រូវ។ គោលការណ៍ភាពឯកជននេះរៀបរាប់ពីរបៀបដែលយើងប្រមូល ប្រើប្រាស់ បញ្ចេញ និងការពារព័ត៌មានរបស់អ្នកនៅពេលអ្នកប្រើប្រាស់កម្មវិធីទូរសព្ទរបស់យើង (ហៅកាត់ថា “កម្មវិធី”) និងសេវាកម្មណាមួយដែលផ្តល់តាមរយៈកម្មវិធី (ហៅជារួមថា “សេវាកម្ម”)។';

  @override
  String get privacyPolicySection1Title =>
      '1. គោលការណ៍ការពារទិន្នន័យផ្ទាល់ខ្លួន';

  @override
  String get privacyPolicySection1Intro =>
      'យើងកំពុងអនុវត្តកិច្ចខិតខំប្រឹងប្រែងដូចខាងក្រោមដើម្បីធានាបាននូវគោលការណ៍មូលដ្ឋាននៃការការពារទិន្នន័យផ្ទាល់ខ្លួន៖';

  @override
  String get privacyPolicySection1Bullet1 =>
      'ថ្នាក់ដឹកនាំ និងបុគ្គលិកទាំងអស់ត្រូវអនុលោមតាមច្បាប់ បទប្បញ្ញត្តិ និងគោលការណ៍ផ្ទៃក្នុងដែលពាក់ព័ន្ធនឹងការការពារទិន្នន័យផ្ទាល់ខ្លួន។';

  @override
  String get privacyPolicySection1Bullet2 =>
      'យើងនឹងពិនិត្យ និងធ្វើបច្ចុប្បន្នភាពគោលការណ៍ និងការអនុវត្តការការពារទិន្នន័យផ្ទាល់ខ្លួនរបស់យើងជាប្រចាំ ដើម្បីធានាថាវាមានប្រសិទ្ធភាព និងអនុលោមតាមច្បាប់ និងបទប្បញ្ញត្តិពាក់ព័ន្ធ។';

  @override
  String get privacyPolicySection1Bullet3 =>
      'យើងនឹងផ្តល់កម្មវិធីបណ្តុះបណ្តាល និងលើកកម្ពស់ការយល់ដឹងជាប្រចាំដល់បុគ្គលិករបស់យើង ដើម្បីធានាថាពួកគេយល់ពីការទទួលខុសត្រូវរបស់ពួកគេពាក់ព័ន្ធនឹងការការពារទិន្នន័យផ្ទាល់ខ្លួន និងមានសមត្ថភាពគ្រប់គ្រងទិន្នន័យផ្ទាល់ខ្លួនដោយសុវត្ថិភាព។';

  @override
  String get privacyPolicySection2Title =>
      '2. របៀបដែលយើងគ្រប់គ្រងព័ត៌មានផ្ទាល់ខ្លួនរបស់អ្នក';

  @override
  String get privacyPolicySection2Body =>
      'យើងនឹងបញ្ជាក់ពីគោលបំណងនៃការប្រមូល និងប្រើប្រាស់ព័ត៌មានផ្ទាល់ខ្លួន ហើយយើងនឹងមិនប្រើប្រាស់វាសម្រាប់គោលបំណងផ្សេងទៀតដោយគ្មានការយល់ព្រមពីអ្នកឡើយ។ យើងនឹងចាត់វិធានការសមស្របដើម្បីការពារព័ត៌មានផ្ទាល់ខ្លួនរបស់អ្នកពីការចូលប្រើប្រាស់ ការបញ្ចេញ ការផ្លាស់ប្តូរ ឬការបំផ្លាញដោយគ្មានការអនុញ្ញាត។ យើងនឹងមិនចែករំលែកព័ត៌មានផ្ទាល់ខ្លួនរបស់អ្នកជាមួយភាគីទីបីដោយគ្មានការយល់ព្រមពីអ្នកឡើយ លើកលែងតែតម្រូវដោយច្បាប់ ឬតាមការចាំបាច់ដើម្បីផ្តល់សេវាកម្មរបស់យើង។';

  @override
  String get privacyPolicySection3Title =>
      '3. របៀបដែលយើងប្រើប្រាស់ព័ត៌មានរបស់អ្នក';

  @override
  String get privacyPolicySection3Intro =>
      'យើងអាចប្រើប្រាស់ព័ត៌មានដែលយើងប្រមូលបានសម្រាប់គោលបំណងផ្សេងៗ រួមមាន៖';

  @override
  String get privacyPolicySection3Bullet1 =>
      'ផ្តល់ ដំណើរការ និងថែរក្សាកម្មវិធី និងសេវាកម្មរបស់យើង';

  @override
  String get privacyPolicySection3Bullet2 =>
      'កែលម្អ កំណត់ឱ្យស្របតាមតម្រូវការ និងពង្រីកកម្មវិធី និងសេវាកម្មរបស់យើង';

  @override
  String get privacyPolicySection3Bullet3 =>
      'ស្វែងយល់ និងវិភាគអំពីរបៀបដែលអ្នកប្រើប្រាស់កម្មវិធី និងសេវាកម្មរបស់យើង';

  @override
  String get privacyPolicySection3Bullet4 =>
      'អភិវឌ្ឍផលិតផល សេវាកម្ម មុខងារ និងសមត្ថភាពថ្មីៗ';

  @override
  String get privacyPolicySection3Bullet5 =>
      'ទំនាក់ទំនងជាមួយអ្នកដោយផ្ទាល់ ឬតាមរយៈដៃគូរបស់យើងណាមួយ រួមទាំងសម្រាប់សេវាកម្មអតិថិជន ដើម្បីផ្តល់ជូនអ្នកនូវព័ត៌មានថ្មីៗ និងព័ត៌មានផ្សេងទៀតទាក់ទងនឹងកម្មវិធី និងសម្រាប់គោលបំណងទីផ្សារ និងផ្សព្វផ្សាយ';

  @override
  String get privacyPolicySection3Bullet6 =>
      'ដំណើរការប្រតិបត្តិការរបស់អ្នក និងគ្រប់គ្រងការបញ្ជាទិញរបស់អ្នក';

  @override
  String get privacyPolicySection3Bullet7 =>
      'ផ្ញើសារអត្ថបទ និងការជូនដំណឹង (push notifications)';
  ...
  @override
  String get privacyPolicySection3Bullet9 => 'អនុលោមតាមកាតព្វកិច្ចច្បាប់';

  @override
  String get privacyPolicySection3Body =>
      'កម្មវិធី CHIP MONG RETAIL APP នឹងមិនលក់ ជួល ឬជួលព័ត៌មានផ្ទាល់ខ្លួនរបស់អ្នកទៅភាគីទីបីឡើយ។ យើងអាចចែករំលែកព័ត៌មានផ្ទាល់ខ្លួនរបស់អ្នកជាមួយអ្នកផ្តល់សេវាភាគីទីបីដែលអនុវត្តសេវាកម្មតំណាងឱ្យយើង ដូចជាដំណើរការការទូទាត់ ការវិភាគទិន្នន័យ ការផ្ញើអ៊ីមែល សេវាកម្មបង្ហោះ សេវាកម្មអតិថិជន និងជំនួយទីផ្សារ។ អ្នកផ្តល់សេវាភាគីទីបីទាំងនេះមានកាតព្វកិច្ចតាមកិច្ចសន្យាក្នុងការការពារព័ត៌មានផ្ទាល់ខ្លួនរបស់អ្នក និងប្រើប្រាស់វាសម្រាប់តែគោលបំណងដែលយើងបង្ហាញដល់ពួកគេប៉ុណ្ណោះ។ យើងក៏អាចបញ្ចេញព័ត៌មានផ្ទាល់ខ្លួនរបស់អ្នកផងដែរ ប្រសិនបើតម្រូវឱ្យធ្វើដូច្នេះដោយច្បាប់ ឬជាការឆ្លើយតបទៅនឹងសំណើស្របច្បាប់ដោយអាជ្ញាធរសាធារណៈ (ឧទាហរណ៍ តុលាការ ឬទីភ្នាក់ងាររដ្ឋាភិបាល)។';

  @override
  String get privacyPolicySection4Title => '4. ជម្រើសរបស់អ្នក';

  @override
  String get privacyPolicySection4Bullet1 =>
      'អ្នកអាចជ្រើសរើសមិនទទួលការទំនាក់ទំនងផ្សព្វផ្សាយពីយើង ដោយធ្វើតាមការណែនាំអំពីការឈប់ជាវនៅក្នុងអ៊ីមែលទីផ្សារណាមួយដែលយើងផ្ញើទៅអ្នក';

  @override
  String get privacyPolicySection4Bullet2 =>
      'អ្នកមានសិទ្ធិចូលមើល កែប្រែ ឬលុបព័ត៌មានផ្ទាល់ខ្លួនរបស់អ្នក';

  @override
  String get privacyPolicySection4Bullet3 =>
      'អ្នកអាចបិទខូគី (cookies) តាមរយៈការកំណត់កម្មវិធីរុករករបស់អ្នក';

  @override
  String get privacyPolicySection5Title => '5. ការចែករំលែកព័ត៌មានរបស់អ្នក';

  @override
  String get privacyPolicySection5Intro =>
      'យើងអាចចែករំលែកព័ត៌មានផ្ទាល់ខ្លួនរបស់អ្នកនៅក្នុងកាលៈទេសៈដូចខាងក្រោម៖';
  ...
  @override
  String get privacyPolicySection6Title => '6. សុវត្ថិភាពទិន្នន័យ';

  @override
  String get privacyPolicySection6Body =>
      'យើងចាត់វិធានការសមស្របដើម្បីការពារព័ត៌មានផ្ទាល់ខ្លួនរបស់អ្នកពីការចូលប្រើប្រាស់ ការបញ្ចេញ ការផ្លាស់ប្តូរ និងការបំផ្លាញដោយគ្មានការអនុញ្ញាត។ ទោះជាយ៉ាងណាក៏ដោយ គ្មានវិធីសាស្ត្របញ្ជូនទិន្នន័យតាមអ៊ីនធឺណិត ឬវិធីសាស្ត្រផ្ទុកទិន្នន័យអេឡិចត្រូនិកណាមួយដែលមានសុវត្ថិភាព 100% ឡើយ។ ដូច្នេះ យើងមិនអាចធានាសុវត្ថិភាពដាច់ខាតរបស់វាបានទេ។';

  @override
  String get privacyPolicySection7Title =>
      '7. ការផ្លាស់ប្តូរចំពោះគោលការណ៍ភាពឯកជននេះ';

  @override
  String get privacyPolicySection7Body =>
      'យើងអាចធ្វើបច្ចុប្បន្នភាពគោលការណ៍ភាពឯកជនរបស់យើងពីពេលមួយទៅពេលមួយ។ យើងនឹងជូនដំណឹងអ្នកអំពីការផ្លាស់ប្តូរណាមួយដោយបង្ហោះគោលការណ៍ភាពឯកជនថ្មីនៅលើទំព័រនេះ។ អ្នកត្រូវបានណែនាំឱ្យពិនិត្យមើលគោលការណ៍ភាពឯកជននេះជាប្រចាំសម្រាប់ការផ្លាស់ប្តូរណាមួយ។ ការផ្លាស់ប្តូរចំពោះគោលការណ៍ភាពឯកជននេះមានប្រសិទ្ធភាពនៅពេលពួកវាត្រូវបានបង្ហោះនៅលើទំព័រនេះ។';

  @override
  String get privacyPolicySection8Title => '8. ទំនាក់ទំនងយើងខ្ញុំ';

  @override
  String get privacyPolicySection8Intro =>
      'ប្រសិនបើអ្នកមានសំណួរណាមួយអំពីគោលការណ៍ភាពឯកជននេះ សូមទាក់ទងមកយើងខ្ញុំតាមរយៈ៖';

  @override
  String get privacyPolicyPhone => 'ទូរសព្ទ៖ (855) 90 877 811';

  @override
  String get copyrightNotice =>
      'រក្សាសិទ្ធិឆ្នាំ 2024 Chip Mong Retails ។ រក្សាសិទ្ធិគ្រប់យ៉ាង។';
}
